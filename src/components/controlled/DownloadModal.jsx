    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[150] p-4">
      <div className="bg-background-main rounded-3xl p-8 max-w-md w-full border border-border-main shadow-2xl">
        ...
        <div className="space-y-4">
          <a href="/easymirror_v1.26.apk" download className="block bg-green-500 hover:bg-green-600 rounded-2xl p-4 transition-all group">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center text-2xl">🤖</div>
              <div className="flex-1">
                <h4 className="text-white font-bold text-lg">Android</h4>
                <p className="text-white/80 text-sm">Download v1.26 APK (App Launcher)</p>
              </div>
