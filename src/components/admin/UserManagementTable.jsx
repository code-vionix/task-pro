...
import { CheckCircle2, Eye, EyeOff, Mail, Shield, Trash2, XCircle } from 'lucide-react';
  ...
  const renderUserRow = (u) => {
    ...
    return (
      <tr key={u.id} className="group hover:bg-[var(--foreground)]/[0.02] transition-colors">
          ...
          <td className="p-5 text-center text-sm font-mono tracking-wide text-[var(--muted)]">
            <div className="inline-flex items-center gap-2 justify-center">
              <span className="min-w-[8ch] text-center">
                {isVisible ? (u.password ?? 'N/A') : '••••••••'}
              </span>
              <button
                type="button"
      ...
      <table className="w-full text-left border-collapse min-w-[1000px]">
          <thead>
              <tr className="border-b border-[var(--border)] bg-[var(--foreground)]/[0.03]">
                  ...
                  <th className="p-5 text-[10px] font-black text-[var(--muted)] uppercase tracking-[0.2em] text-center">
                    Password
                  </th>
