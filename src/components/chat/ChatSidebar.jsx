 ...
 */
export default function ChatSidebar({ chats, selectedUser, onSelectChat, isGuest, showSidebar, isLoading }) {
  return (
    <div className={clsx(
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        {isLoading ? (
            <div className="p-10 flex items-center justify-center h-full text-blue-500/50">
