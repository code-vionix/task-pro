...
import { BookOpen, Camera, Globe, Loader2, Lock, MapPin, Save, Settings, User as UserIcon } from 'lucide-react';
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-[var(--border)]">
                <div>
                    <div className="flex items-center gap-3 mb-2 text-blue-500">
                        ...
                        <span className="text-xs font-black tracking-widest uppercase">System Config</span>
                    </div>
                    ...
                    <p className="text-[var(--muted)] mt-2 max-w-lg">
                        Fine-tune your identity and security parameters within the TaskPro ecosystem.
                    </p>
                </div>
            </div>
                ...
                <div className="lg:col-span-2 space-y-8">
                    <section className="glass-card p-8 relative overflow-hidden">
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                <h2 className="text-xl font-black text-[var(--foreground)] uppercase tracking-tighter">Identity Profile</h2>
                        ...
                        <form onSubmit={handleProfileUpdate} className="space-y-6">
                            ...
                            <FormInput 
                                ...
                                placeholder="A brief transmission about yourself..." 
                                isTextarea
                            />
                    ...
                    <section className="glass-card p-8">
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                <h2 className="text-xl font-black text-[var(--foreground)] uppercase tracking-tighter">Security Protocols</h2>
                                <p className="text-[var(--muted)] text-xs font-bold uppercase tracking-widest">Encrypted Key Rotation</p>
                            </div>
                        </div>
